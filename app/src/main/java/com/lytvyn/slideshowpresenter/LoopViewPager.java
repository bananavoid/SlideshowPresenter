...
public class LoopViewPager extends ViewPager {
    ...
    public void startAutoScroll() {
        //LoopViewPager.super.beginFakeDrag();
    ...
    final Runnable Update = new Runnable() {
        public void run() {
//            if (currentPage == mAdapter.getRealCount()) {
//                currentPage = 0;
//            }

//            LoopViewPager.super.setCurrentItem(currentPage++, true);
            if (LoopViewPager.super.isFakeDragging()) {
                LoopViewPager.super.fakeDragBy(2.0f);
                LoopViewPager.super.endFakeDrag();
            }
        }
    };
